...
MODEL = tf.keras.models.load_model("C:/Users/LENOVO/Desktop/leaf disease/models/5")
...
async def predict(file: UploadFile = File(...)):
    try:
        ...
        confidence = float(np.max(prediction[0]) * 100)  # Convert probability to percentage
